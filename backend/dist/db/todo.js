    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    time = Date.now();
                    return [4 /*yield*/, db_1["default"].query('INSERT INTO todos(name, timeCreated) VALUES($1, $2)', [
                            name,
                            time,
                        ])];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, db_1["default"].query('SELECT * FROM todos WHERE timeCreated = $1', [time])];
